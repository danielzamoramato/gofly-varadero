export const t = {
  es: {
    ...
    hero: {
      tag: "Varadero, Cuba",
      title1: "Vuela sobre el",
      titleHighlight: "Caribe",
      title2: "en paramotor",
      sub: "Una experiencia única sobrevolando las playas más hermosas de Cuba. Vuelos biplaza, seguros y memorables.",
  ...
  en: {
    ...
    hero: {
      tag: "Varadero, Cuba",
      title1: "Fly over the",
      titleHighlight: "Caribbean",
      title2: "by paramotor",
      sub: "A unique experience soaring over the most beautiful beaches in Cuba. Tandem flights, safe and unforgettable.",
